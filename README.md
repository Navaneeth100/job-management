# 📝 Expense Tracker Project (MERN Stack)

This is a **Expense Tracker Application** built using the **MERN stack (MongoDB, Express, React, Node.js)**.  
...
- **Frontend (Vercel):** [Expense Tracker Frontend](https://mini-blog-frontend-beta.vercel.app)  
- **Backend (Render):** [Expense Tracker Backend API](https://mini-blog-backend.onrender.com)  
